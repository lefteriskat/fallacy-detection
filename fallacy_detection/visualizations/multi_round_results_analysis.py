...
def extract_metrics(
    ...
    filename = f"reports_mr2/{model_name.replace('/', '-')}_prompt{prompt_option}_no_cot_{fallacy_class.name}_results{'_with_definitions' if definitions else '_no_definitions'}.csv"
